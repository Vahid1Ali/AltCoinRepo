...
uint256 hashGenesisBlock("0xd0410fc36a1fdb79c3a549bfa9dd0fa710d4a5dbf381e9dd0efcc017a6d7e028");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc7ccca3a5721ed976e3d0439e16c5ec303ab613623a57251860d527ed2a20e72");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1545977880;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085904417;

        if (fTestNet)
        {
            block.nTime    = 1545977833;
            block.nNonce   = 386838796;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xc4711e75ac817aff863d72198012b59b0e943e19768c7f5119583a87b28dd56c"));
        block.print();
